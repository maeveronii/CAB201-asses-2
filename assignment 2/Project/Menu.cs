...
class Menu{
    ...
    private void registerPatientMenu()
    {
        ...
        userPatient = new Patient(name, age, mobile, email, password);
    ...
    private void registerFloorManagerMenu()
    {
        ...
        userFloorManager = new FloorManager(name, age, mobile, email, password, staffID, floorNumber);
    ...
    private void registerSurgeonMenu()
    {
        ...
        userSurgeon = new Surgeon(name, age, mobile, email, password, staffID, specialty);
